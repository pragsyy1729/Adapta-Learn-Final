"""
Simple resume parser using GROQ API
...
class GroqResumeParser:
    def __init__(self, api_key: Optional[str] = None):
        ...
        self.model = "llama-3.1-8b-instant"  # Using Llama as it's good for analysis tasks
    ...
    def parse_resume_for_skills(self, resume_text: str, target_skills: List[str], target_role: str = "") -> Dict:
        """
        Parse resume text and extract skill proficiency levels using GROQ
...
"""
    ...
    def _create_fallback_analysis(self, target_skills: List[str]) -> Dict:
        """Create a fallback analysis if GROQ fails"""
        return {
            "skills_analysis": {
                skill: {
    ...
    def analyze_resume_file(self, file_path: str, target_skills: List[str], target_role: str = "") -> Dict:
        ...
        analysis['metadata'] = {
            ...
            'analysis_method': 'groq-mixtral-8x7b'
        }
